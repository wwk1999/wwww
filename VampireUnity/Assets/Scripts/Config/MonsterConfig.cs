...
public class MonsterConfig
{
   public static Dictionary<MonsterTypeByName, MonsterType> MonsterTypeDic =
    new Dictionary<MonsterTypeByName, MonsterType>()
    {
        ...
        { MonsterTypeByName.LuRen, MonsterType.Boss },
        { MonsterTypeByName.NiRen, MonsterType.Boss },
    };
        ...
        {
            {
                ...
                new MonsterInfo()
                {
                    attack = 10, defence = 10, hp = 20, ex = 10, linghun = 10,speed = 1.2f,
            ...
            },
            {
                ...
                new MonsterInfo()
                {
                    attack = 20, defence = 20, hp = 100, ex = 40, linghun = 40,speed = 1.2f,
                    MonsterEquipList = new List<MonsterEquip>()
            ...
            },
            {
                ...
                new MonsterInfo()
                {
                    attack = 50, defence = 20, hp = 1000, ex = 200, linghun = 200,speed = 1.2f,
                    MonsterEquipList = new List<MonsterEquip>()
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    attack = 20, defence = 20, hp = 50, ex = 20, linghun = 20,speed = 1.2f,
                    MonsterEquipList = new List<MonsterEquip>()
            ...
            },
            {
                ...
                new MonsterInfo()
                {
                    attack = 50, defence = 50, hp =400, ex = 100, linghun = 100,speed = 1.2f,
                    MonsterEquipList = new List<MonsterEquip>()
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    attack = 30, defence = 30, hp = 100, ex = 30, linghun = 30,speed = 1.2f,
                    MonsterEquipList = new List<MonsterEquip>()
            ...
            },
            {
                ...
                new MonsterInfo()
                {
                    attack = 100, defence = 80, hp = 1000, ex = 200, linghun = 200,speed = 1.2f,
                    MonsterEquipList = new List<MonsterEquip>()
            ...
            },
            {
                ...
                new MonsterInfo()
                {
                    ...
                    {  new MonsterEquip(PlayerEquipConfig.EquipType.Ring, PlayerEquipConfig.EquipLevel.Blue, 5), 
                        ...
                        new MonsterEquip(PlayerEquipConfig.EquipType.Cloak, PlayerEquipConfig.EquipLevel.Blue, 5),
                        new MonsterEquip(PlayerEquipConfig.EquipType.Cloth, PlayerEquipConfig.EquipLevel.Blue, 5),
                        new MonsterEquip(PlayerEquipConfig.EquipType.Shoe, PlayerEquipConfig.EquipLevel.Blue, 5),
                        new MonsterEquip(PlayerEquipConfig.EquipType.Helmet, PlayerEquipConfig.EquipLevel.Blue, 5),
                    }
                }
            },
            {
                ...
                new MonsterInfo()
                {
                    ...
                    {  new MonsterEquip(PlayerEquipConfig.EquipType.Ring, PlayerEquipConfig.EquipLevel.XueRen, 15), 
                        ...
                        new MonsterEquip(PlayerEquipConfig.EquipType.Cloak, PlayerEquipConfig.EquipLevel.XueRen, 15),
                        new MonsterEquip(PlayerEquipConfig.EquipType.Cloth, PlayerEquipConfig.EquipLevel.XueRen, 15),
                        new MonsterEquip(PlayerEquipConfig.EquipType.Shoe, PlayerEquipConfig.EquipLevel.XueRen, 15),
                        new MonsterEquip(PlayerEquipConfig.EquipType.Helmet, PlayerEquipConfig.EquipLevel.XueRen, 15),
                    }                   
                }
            },
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    attack = 100, defence = 100, hp = 10000, ex = 10, linghun = 10,speed = 1.2f,orangeEquip = true
                }
            },
            {
            ...
            },
            {
                ...
                new MonsterInfo()
                {
                    attack = 100, defence = 100, hp = 1000000, ex = 10, linghun = 10,speed=1.2f,orangeEquip = true
                }
            },
            ...
            },
            {
                ...
                new MonsterInfo()
                {
                    attack = 1001, defence = 100, hp = 500000, ex = 10, linghun = 10,speed=1.2f,orangeEquip = true
                }
            },
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    attack = 50, defence = 50, hp = 100, ex = 20, linghun = 20,speed=1.2f,
            ...
            },
            {
                ...
                new MonsterInfo()
                {
                    attack = 100, defence = 100, hp = 500, ex = 100, linghun = 100,speed=1.2f,
                    MonsterPropList = new List<MonsterProp>()
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.WeaponFragment,1),50),
                    }
                }
            },
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    attack = 150, defence = 150, hp = 300, ex = 50, linghun = 50,speed=1.2f,
                    MonsterPropList = new List<MonsterProp>()
                    {
            ...
            },
            {
                ...
                new MonsterInfo()
                {
                    attack = 300, defence = 300, hp = 1500, ex = 250, linghun = 250,speed=1.2f,
                    MonsterPropList = new List<MonsterProp>()
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.WeaponFragment,2),50),
                    }
                }
            },
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    attack = 450, defence = 450, hp = 1000, ex = 150, linghun = 150,speed=1.2f,
                    MonsterPropList = new List<MonsterProp>()
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.WeaponFragment,3),5),
                    }
                }
            },
            {
                ...
                new MonsterInfo()
                {
                    attack = 900, defence = 900, hp = 5000, ex = 500, linghun = 500,speed=1.2f,
                    MonsterPropList = new List<MonsterProp>()
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.WeaponFragment,3),50),
                    }
                }
            },
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    attack = 100, defence = 100, hp = 10000, ex = 10, linghun = 10,speed=1.2f,
                    MonsterPropList = new List<MonsterProp>()
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.WeaponFragment,2),5),
                        new MonsterProp(new PropItem(PropConfig.PropType.WeaponFragment,2),5)
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    ...
                    MonsterPropList = new List<MonsterProp>()
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuDan,3),1),
                        new MonsterProp(new PropItem(PropConfig.PropType.SkillShu,1),1),
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuShiWu,1),5),
            ...
            },
            {
                ...
                new MonsterInfo()
                {
                    ...
                    MonsterPropList = new List<MonsterProp>()
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuDan,3),5),
                        new MonsterProp(new PropItem(PropConfig.PropType.SkillShu,1),5),
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuShiWu,1),25),
                    }
                }
            },
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    ...
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuDan,3),1),
                        new MonsterProp(new PropItem(PropConfig.PropType.SkillShu,2),1),
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuShiWu,2),5),
                    }
                }
            },
            {
                ...
                new MonsterInfo()
                {
                    ...
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuDan,3),5),
                        new MonsterProp(new PropItem(PropConfig.PropType.SkillShu,2),5),
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuShiWu,2),25),
                    }
                }
            },
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    ...
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuDan,3),1),
                        new MonsterProp(new PropItem(PropConfig.PropType.SkillShu,3),1),
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuShiWu,3),5),
                    }
                }
            },
            {
                ...
                new MonsterInfo()
                {
                    ...
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuDan,3),5),
                        new MonsterProp(new PropItem(PropConfig.PropType.SkillShu,3),5),
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuShiWu,3),25),
                    }
                }
            },
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    ...
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuDan,3),1),
                        new MonsterProp(new PropItem(PropConfig.PropType.SkillShu,4),1),
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuShiWu,4),5),
                    }
                }
            },
            {
                ...
                new MonsterInfo()
                {
                    ...
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuDan,3),5),
                        new MonsterProp(new PropItem(PropConfig.PropType.SkillShu,4),5),
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuShiWu,4),25),
                    }
                }
            },
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    ...
                    MonsterPropList = new List<MonsterProp>()
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuDan,5),1),
                        new MonsterProp(new PropItem(PropConfig.PropType.SkillShu,5),1),
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuShiWu,5),5),
                    }
                }
            },
            {
                ...
                new MonsterInfo()
                {
                    ...
                    MonsterPropList = new List<MonsterProp>()
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuDan,5),5),
                        new MonsterProp(new PropItem(PropConfig.PropType.SkillShu,5),5),
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuShiWu,5),25),
                    }
                }
            },
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    ...
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuDan,5),1),
                        new MonsterProp(new PropItem(PropConfig.PropType.SkillShu,6),1),
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuShiWu,6),5),
                    }
                }
            },
            {
                ...
                new MonsterInfo()
                {
                    ...
                    {
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuDan,5),5),
                        new MonsterProp(new PropItem(PropConfig.PropType.SkillShu,6),5),
                        new MonsterProp(new PropItem(PropConfig.PropType.ChongWuShiWu,6),25),
                    }
                }
            },
            ...
            
            {
                ...
                new MonsterInfo()
                {
                    attack = 10, defence = 10, hp = 100, ex = 10, linghun = 10,speed=1.2f,
                    MonsterPropList = new List<MonsterProp>()
                    {
            ...
            },
            {
                ...
                new MonsterInfo()
                {
                    attack = 100, defence = 100, hp = 100, ex = 10, linghun = 10,speed=1.2f,
                    MonsterPropList = new List<MonsterProp>()
                    {
