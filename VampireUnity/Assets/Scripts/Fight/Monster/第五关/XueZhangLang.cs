...
public class XueZhangLang : MonsterBase
{
    ...
    public void OnSpineEvent(TrackEntry trackEntry, Spine.Event e)
    {
        ...
        {
            if (Vector2.Distance(attackTrans.position, QueueController.S.gamePlayer.transform.position) < size||Vector2.Distance(transform.position, QueueController.S.gamePlayer.transform.position) < size)
            {
