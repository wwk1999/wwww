...
{
    public ShaNiao() : base(MonsterType.Normal, "ShaNiao", 1, 100, 0.3f, 10, 5, 10, 10, 0)
    {
    }
    ...
    public void OnSpineEvent(TrackEntry trackEntry, Spine.Event e)
    {
        ...
        {
            if (Vector2.Distance(attackTrans.position, GameController.S.gamePlayer.transform.position) < 0.5f)
            {
