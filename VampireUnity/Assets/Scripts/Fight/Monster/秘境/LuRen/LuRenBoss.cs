...
public class LuRenBoss : MonsterBase
{
   ...
   public override void Hurt(float damage,bool isCrit,DamageFrom damageFrom,YuanSuType yuanSuType)
    ...
    public void OnSpineEvent(TrackEntry trackEntry, Spine.Event e)
    {
        ...
        {
            CheckCollisionWithMonsters(skill3Tri);
            var lurendici = QueueController.S.LuRenDiCiQueue.Dequeue();
            lurendici.transform.position=QueueController.S.gamePlayer.transform.position;
            lurendici.gameObject.SetActive(true);
        }
