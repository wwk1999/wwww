    ...
    public void CheckCollisionWithMonsters(Collider2D collider2D)
    {
        ...
        foreach (Collider2D col in results)
        {
            if (col.CompareTag("Monster") || col.CompareTag("Boss"))
            {
                ...
                monster.Hurt(GameController.S.GameAttack*2f*SkillController.S.DianYuanSuDamage*(1.0f+GlobalPlayerAttribute.Skill1DamageNum/100.0f),GameController.S.GetIsCrit(),DamageFrom.Skill1);
