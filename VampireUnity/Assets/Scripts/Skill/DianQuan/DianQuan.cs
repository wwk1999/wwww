    ...
    public void CheckCollisionWithMonsters(Collider2D collider2D)
    {
        ...
        foreach (Collider2D col in results)
        {
            if (col.CompareTag("Monster") || col.CompareTag("Boss"))
            {
                ...
                monster.Hurt(QueueController.S.GameAttack*SkillConfig.Dian1Damage/100f*SkillController.S.DianYuanSuDamage*(GlobalPlayerAttribute.FinalChongWuAttribute.DianSkillDamage+1.0f),GameController.S.GetIsCrit(),DamageFrom.Skill1,YuanSuType.Dian);
