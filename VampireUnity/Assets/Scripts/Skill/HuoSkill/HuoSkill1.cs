...
public class HuoSkill1 : MonoBehaviour
{
  ...
  private void OnTriggerEnter2D(Collider2D other)
  {
    ...
    if (other.CompareTag("Monster")||other.CompareTag("Boss"))
    {
      ...
      GameController.S.MonsterColliderDic[other].Hurt(GameController.S.GameAttack*SkillController.S.HuoYuanSuDamage*(1.0f+GlobalPlayerAttribute.HuoSkill1Num/100.0f),isCrit,DamageFrom.Skill1);
      //hit.SetActive(true);
    }
  }
