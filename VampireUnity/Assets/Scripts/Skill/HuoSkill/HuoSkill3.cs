  ...
  public void CheckCollisionWithMonsters()
  {
    ...
    foreach (Collider2D col in results)
    {
      ...
      if (col.CompareTag("Monster") || col.CompareTag("Boss"))
      {
        ...
        monster.Hurt(QueueController.S.GameAttack*SkillConfig.Huo3Damage/100f*SkillController.S.HuoYuanSuDamage*(GlobalPlayerAttribute.FinalChongWuAttribute.HuoSkillDamage+1.0f)*(1.0f),GameController.S.GetIsCrit(),DamageFrom.Skill,YuanSuType.Huo);
