  ...
  public void CheckCollisionWithMonsters()
  {
    ...
    foreach (Collider2D col in results)
    {
      ...
      if (col.CompareTag("Monster") || col.CompareTag("Boss"))
      {
        ...
        monster.Hurt(GameController.S.GameAttack*2.5f*SkillController.S.HuoYuanSuDamage*(1.0f+GlobalPlayerAttribute.HuoSkill3Num/100.0f),GameController.S.GetIsCrit(),DamageFrom.Normal);
