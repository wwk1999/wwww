  ...
  public void CheckCollisionWithMonsters()
  {
    ...
    foreach (Collider2D col in results)
    {
      ...
      if (col.CompareTag("Monster") || col.CompareTag("Boss"))
      {
        ...
        monster.Hurt(GameController.S.GameAttack*SkillConfig.Huo3Damage*SkillController.S.HuoYuanSuDamage*(GlobalPlayerAttribute.FinalChongWuAttribute.HuoSkillDamage+1.0f)*(1.0f),GameController.S.GetIsCrit(),DamageFrom.Normal,YuanSuType.Huo);
