...
public class DianSkill3 : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.CompareTag("Monster")||other.CompareTag("Boss"))
        {
            ...
            GameController.S.MonsterColliderDic[other].Hurt(GameController.S.GameAttack*2*(GlobalPlayerAttribute.FinalChongWuAttribute.DianSkillDamage+1.0f)*SkillController.S.DianYuanSuDamage*(1.0f+GlobalPlayerAttribute.DianSkill3Num/100.0f),isCrit,DamageFrom.Normal);
            hit.SetActive(true);
        }
    }
}
