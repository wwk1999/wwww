...
public class Ice4BaoZha : MonoBehaviour
{
    ...
    public void Hide()
    {
        QueueController.S.Ice4BaoZhaQueue.Enqueue(this);
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.CompareTag("Monster")||other.CompareTag("Boss"))
        {
            ...
            QueueController.S.MonsterColliderDic[other].Hurt(QueueController.S.GameAttack*SkillController.S.HuoYuanSuDamage,isCrit,DamageFrom.NormalAttack,YuanSuType.Ice);
            hit.SetActive(true);
            QueueController.S.Ice4BaoZhaQueue.Enqueue(this);
            var baozha1=QueueController.S.Ice4BaoZhaItemQueue.Dequeue();
            ...
            var baozha2=QueueController.S.Ice4BaoZhaItemQueue.Dequeue();
            ...
            var baozha3=QueueController.S.Ice4BaoZhaItemQueue.Dequeue();
            ...
            var baozha4=QueueController.S.Ice4BaoZhaItemQueue.Dequeue();
