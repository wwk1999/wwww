   ...
   public void CheckCollider()
   {
      ...
      foreach (Collider2D col in results)
      {
         ...
         if (col.CompareTag("Monster")||col.CompareTag("Boss"))
         {
            ...
            QueueController.S.MonsterColliderDic[col].Hurt(QueueController.S.GameAttack*1.5f*SkillController.S.DianYuanSuDamage,crit,DamageFrom.NormalAttack,YuanSuType.Ice);
         }
      }
   }
   public void Hide()
   {
      QueueController.S.Ice4BaoZhaItemQueue.Enqueue(this);
